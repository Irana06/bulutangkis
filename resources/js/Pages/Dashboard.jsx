                    ...
                    <a href="#">
                        <div className="flex justify-center lg:justify-start items-center gap-2 py-4 px-0 md:px-2 lg:px-4 cursor-pointer">
                            <img
                                ...
                                alt="logo"
                            />
                            <span className="tracking-wide font-semibold text-2xl tracking-wide truncate capitalize hidden lg:block">
                                Bulutangkis
                            </span>
                        </div>
                    </a>
                            ...
                            >
                                <ul className="py-1">
                                    {[
                                        ...
                                        {
                                            href: "/tanding/ganda",
                                            label: "Kategori Ganda",
                                        },
                                        {
                                            href: "/tanding/campuran",
                                            label: "Kategori Campuran",
                                        },
                                    ].map(({ href, label }) => (
                                        <li key={href}>
                                            <a
                                            ...
                                            >
                                                <svg
                                                    ...
                                                    strokeLinecap="round"
                                                    strokeLinejoin="round"
                                                    className="w-4 h-4 min-w-[16px] min-h-[16px] flex-shrink-0 mr-2"
                                                >
