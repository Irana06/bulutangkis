                        ...
                        {data.map((item, idx) => (
                            <tr key={idx}>
                                ...
                                <td className="px-6 py-4 whitespace-nowrap md:hidden relative">
                                    ...
                                    <div
                                        className={`absolute right-0 mt-2 bg-white rounded-lg transition-all duration-200 ease-in-out transform origin-top-right z-50 w-auto min-w-[50px] md:min-w-[200px] max-w-xs ${
                                            dropdownOpenIndex === idx
