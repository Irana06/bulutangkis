...
<body class="flex flex-col min-h-screen gap-y-4">
    <!-- Navbar -->
    <header x-data="{ isOpen: false, isCollapsed: false }"
        ...
        <div class="px-6 py-2 flex items-center justify-between transition-all duration-500"
            ...
            <div class="hidden md:flex md:items-center md:gap-5 transition-all duration-300"
                :class="isCollapsed ? 'opacity-0 scale-90 overflow-hidden' : 'opacity-100 scale-100'">
                <a class="rounded-lg px-2 py-1 text-sm font-medium text-gray-900 hover:bg-gray-100"
                    href="#">Home</a>
                <a class="rounded-lg px-2 py-1 text-sm font-medium text-gray-900 hover:bg-gray-100" href="#">Cek
                    Data</a>
            </div>
        ...
        <div x-show="isOpen" x-transition class="md:hidden bg-white shadow-lg py-4 mt-2 rounded-lg overflow-hidden">
            ...
            <a class="block px-4 py-2 text-blue-600 font-semibold hover:bg-gray-100 w-full text-center"
                href="/login">Registrasi</a>
            <a class="block px-4 py-2 bg-blue-600 text-white font-semibold rounded-md w-4/5 text-center hover:bg-blue-500"
                href="/login">Masuk</a>
        </div>
    </header>
    ...
    <!-- Footer -->
    <footer>
        <div class="text-center absolute bottom-0 w-full bg-white/80 py-6">
            <a href="#" class="flex items-center justify-center mb-5 text-2xl font-semibold text-gray-900">
                <img src="https://smkmuhpakem.sch.id/wp-content/uploads/2023/02/logo.png" class="h-12 mr-3 sm:h-9"
                    alt="smkmupa" />
